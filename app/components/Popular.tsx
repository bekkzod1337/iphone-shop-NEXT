...
export default function DiscountProducts() {
  ...
  return (
    <section className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 px-6 md:px-20 relative overflow-hidden text-white">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-pink-500/10 to-yellow-500/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-12">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-4xl font-bold bg-gradient-to-r from-white via-blue-300 to-purple-300 bg-clip-text text-transparent">
                Discount Products
              </h2>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map(({ id, image, title, oldPrice, newPrice, discount, rating, reviews }) => (
            <div
              key={id}
              className="group relative bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-6 flex flex-col border border-gray-700 hover:border-blue-400/50 hover:-translate-y-2"
              onMouseEnter={() => setHoveredProduct(id)}
            >
              {/* Image */}
              <div className="relative w-full h-64 mb-6 overflow-hidden rounded-xl bg-gradient-to-br from-gray-700 to-gray-800">
                <Image
                  src={image}
                  alt={title}
                  fill
                ...
                <div className={`absolute top-3 right-3 flex flex-col gap-2 transition-all duration-300 ${
                  ...
                  <button className="p-2 bg-gray-900/80 backdrop-blur-sm rounded-full shadow-lg hover:bg-gray-800 transition-all duration-200 hover:scale-110">
              ...
              <div className="flex-1 space-y-3">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-white line-clamp-2 group-hover:text-blue-400 transition-colors duration-200">
                  {title}
                </h3>
